...
function main() {
  ...
  var perspectiveMatrix = utils.MakePerspective(90, gl.canvas.width/gl.canvas.height, 0.1, 100.0);//*****NEW*****//
  console.log(perspectiveMatrix);//*****NEW*****//
  var viewMatrix = utils.MakeView(1.0, 0.8, 1.0, -30.0, -60.0);//*****NEW*****//
  console.log(viewMatrix);//*****NEW*****//
