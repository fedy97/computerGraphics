...
function main() {
  ...
  //here we write the indexes of the triangle, not the vertexes directly
  ...
  var matrix = utils.MakeTranslateMatrix(0.2,-0.2,0.0);//*****NEW*****//
  ...
  gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, indexBuffer);
  //we use drawelements to use indexes of the vertexes
  //in the order specified in the indexbuffer(indices)
  //drawelelemtns will draw to the just bounded buffer
